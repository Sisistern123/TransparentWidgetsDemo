...
- (instancetype)initWithCoder:(NSCoder *)coder {
    if (self = [super init]) {
        ...
        for (id widgetDescriptor in widgetDescriptors) {
            ...
            if ([kind isEqualToString:@"MyClearWidget1"]
             || [kind isEqualToString:@"MyClearWidget2"]
             || [kind isEqualToString:@"MyClearWidget3"]
             || [kind isEqualToString:@"MyClearWidget4"]
             || [kind isEqualToString:@"MyClearWidget"]
             || [kind isEqualToString:@"BayernHolidayWidget"]
             || [kind isEqualToString:@"MyClearToDoWidget"])
            {
